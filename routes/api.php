    ...
    function (): void {
        ...
        Route::middleware(['auth'])
            ...
            ->group(function (): void {
                ...
                Route::get('recentlyUpdated', [SeriesController::class, 'recentlyUpdated'])->name(
                ...
                Route::get('{serie}/chapters/{chapter}/pages', [SeriesController::class, 'pages'])->name(
        ...
        Route::middleware(['auth'])
            ->prefix('tracking')
            ->group(function (): void {
                Route::post('cookie/{chapter}', [TrackingController::class, 'cookie'])->name('tracking.cookie');
                Route::post('refresh/{cookie}', [TrackingController::class, 'refresh'])->name('tracking.refresh');
            });
    },
);
